...
Microsoft::WRL::ComPtr<ID3D12PipelineState> PSOManager::GetParticleSpritePSO(BlendMode blendMode)
{
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> PSOManager::GetObjectSpritePSO()
{
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> PSOManager::GetAnimationSpritePSO()
{
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> PSOManager::GetOffScreenSpritePSO(OffScreenEffectType effectType)
{
...
void PSOManager::CreateObjectPSO()
{
	...
	graphicsPipelineStateDesc.VS = { vertexShaderBlob->GetBufferPointer(), vertexShaderBlob->GetBufferSize() };	// vertexShader
	graphicsPipelineStateDesc.PS = { pixelShaderBlob->GetBufferPointer(), pixelShaderBlob->GetBufferSize() }; // PixelShade
	graphicsPipelineStateDesc.BlendState = blendDesc; // BlendStatez
	graphicsPipelineStateDesc.RasterizerState = rasterizerDesc;	// RasterizerState
	// 書き込むRTVの情報
	graphicsPipelineStateDesc.NumRenderTargets = 1;
	graphicsPipelineStateDesc.RTVFormats[0] = DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
...
void PSOManager::CreateOffScreenPSO(OffScreenEffectType effectType)
{
	...
	case OffScreenEffectType::kGray:
		...
		break;
	case OffScreenEffectType::kVigneet:
		vertexShaderBlob = dxManager_->CompileShader(L"./resource/shaders/Fullscreen.VS.hlsl", L"vs_6_0");
		pixelShaderBlob = dxManager_->CompileShader(L"./resource/shaders/Vignette.PS.hlsl", L"ps_6_0");
		break;
	case OffScreenEffectType::kSmooth:
		vertexShaderBlob = dxManager_->CompileShader(L"./resource/shaders/Fullscreen.VS.hlsl", L"vs_6_0");
		pixelShaderBlob = dxManager_->CompileShader(L"./resource/shaders/Smoothing.PS.hlsl", L"ps_6_0");
		break;
	}
