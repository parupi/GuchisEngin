...
public:// アクセッサ
	...
	Microsoft::WRL::ComPtr<ID3D12PipelineState> GetParticleSpritePSO(BlendMode blendMode);
	// オブジェクト
	Microsoft::WRL::ComPtr<ID3D12RootSignature> GetObjectSignature() { return objectSignature_; }
	Microsoft::WRL::ComPtr<ID3D12PipelineState> GetObjectSpritePSO();
	// アニメーション
	Microsoft::WRL::ComPtr<ID3D12RootSignature> GetAnimationSignature() { return animationSignature_; }
	Microsoft::WRL::ComPtr<ID3D12PipelineState> GetAnimationSpritePSO();
	// オフスクリーン
	Microsoft::WRL::ComPtr<ID3D12RootSignature> GetOffScreenSignature() { return offScreenSignature_; }
	Microsoft::WRL::ComPtr<ID3D12PipelineState> GetOffScreenSpritePSO(OffScreenEffectType effectType);
