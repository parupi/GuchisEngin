...
void LightManager::CreateSpotLightResource()
{
	...
	spotLightData1_->direction = Normalize({ -1.0f, -1.0f, 0.0f });
	...
	spotLightData2_->direction = Normalize({ -1.0f, -1.0f, 0.0f });
	...
	spotLightData3_->direction = Normalize({ -1.0f, -1.0f, 0.0f });
